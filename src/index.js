...
app.post(
  "/request-supervisor",
  passport.authenticate("jwt", { session: false }),
  routes.requestSupervisor
);
app.get(
  "/get-all-faculties",
  passport.authenticate("jwt", { session: false }),
  routes.getAllFaculty
);
app.post(
  "/request/approve/:id",
  passport.authenticate("jwt", { session: false }),
  routes.requestApprove
);
app.post(
  "/request/reject/:id",
  passport.authenticate("jwt", { session: false }),
  routes.requestReject
);
app.get(
  "/scholar/request-data",
  passport.authenticate("jwt", { session: false }),
  routes.getRequestData
);
app.put(
  "/update-supervisor/:_id",
  passport.authenticate("jwt", { session: false }),
...
app.get(
  "/get-all-supervisor",
  passport.authenticate("jwt", { session: false }),
  routes.getAllSupervisor
);
app.delete("/delete", routes.deleteAll);
app.patch(
  "/director/finalize-supervisor/:_id",
  passport.authenticate("jwt", { session: false }),
  routes.finalizeSupervisor
);
app.patch(
  "/director/finalize-supervisor-request/:_id",
  passport.authenticate("jwt", { session: false }),
  routes.finalizeSupervisorRequest
);
app.patch(
  "/director/finalize-supervisor-request/:scholar_id/:supervisor_id/:fullName",
  passport.authenticate("jwt", { session: false }),
